...
int main(int argc, char ** argv) {
    ...
    while(blueprint_count < 3 && fscanf(file, " Blueprint %d: Each ore robot costs %d ore. Each clay robot costs %d ore. Each obsidian robot costs %d ore and %d clay. Each geode robot costs %d ore and %d obsidian. "
        ...
        //calculate
        max_product *= max_geodes(blueprint, robots, resources, TIME_AVAILABLE, 0);

        fprintf(stderr, "Blueprint %d done\n", blueprint_number);
